# RESULTS — FIND-DX-0020

_Written by the improvement agent (claude-fable-5-1), 2026-09-20. Codes and counts only; no encounter text._

Gate: **PASS** (`tasks/FIND-DX-0020/GATE.md`), base `05b6e64` -> head `9d30187`, three runs (seeds 1, 2, 3), run inside the task
...
|---|---|---|
| targeted error rate | 0.889 | 0.222 (runs [0.0, 0.333, 0.333]) |
...
A deterministic rule after line mapping un-codes a diagnosis of a listed class (R42 for this finding: a review-of-systems positive coded as a diagnosis)
