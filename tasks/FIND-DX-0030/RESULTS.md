...
Gate: **PASS** (`tasks/FIND-DX-0030/GATE.md`), base `05b6e64` -> head `9d30187`, three runs (seeds 1, 2, 3), run inside the task
...
|---|---|---|
| targeted error rate | 1.000 | 0.400 (runs [0.4, 0.4, 0.4]) |
...
A deterministic rule after line mapping un-codes a diagnosis of a listed class (Z87 personal-history codes for this finding: personal history that is simply recorded (social history, a passing mention))
