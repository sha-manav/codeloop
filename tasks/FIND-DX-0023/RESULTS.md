# RESULTS — FIND-DX-0023

_Written by the improvement agent (claude-fable-5-1), 2026-09-20. Codes and counts only; no encounter text._

Gate: **PASS** (`tasks/FIND-DX-0023/GATE.md`), base `05b6e64` -> head `9d30187`, three runs (seeds 1, 2, 3), run inside the task
...
|---|---|---|
| targeted error rate | 1.000 | 0.000 (runs [0.0, 0.0, 0.0]) |
...
A deterministic rule after line mapping un-codes a diagnosis of a listed class (R63 weight-change codes for this finding: weight-change symptoms from the HPI or review of systems)
